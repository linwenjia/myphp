...
class Page {
    ...
    function __get($args){
        if($args == "limit" || $args == "page" || $args == "pageNum")
            return $this->$args;
        else
            return null;
    }
    ...
    function fpage_old(){
        ...
        $fpage = '<span class="brofenye"><ul class="fpage_ul" style="margin:0px;padding:0px;list-style:none;float:right">';
        if(count($arr) < 1)
...
html;
    ...
    private function pageList(){
        ...
        if($this->pageNum > 1){
            ...
            //$linkPage .= "<li><a class='active'>{$this->page}</a></li>";
        }
