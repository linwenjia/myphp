...
(function($){
    $.fn.yxMobileSlider = function(settings){
        ...
        return this.each(function(){
            ...
            //初始化焦点容器及按钮
            var fang1='<div class="js_text">1111</div><div class="annui"></div>';
            _this.append('<div class="focus">'+fang1+'</div>');
            var oFocusContainer = $(".focus");
            for (var i = 0; i < num; i++) {
            	var tu_text=$(".slider ul li a img").attr("title");
            	$(".js_text").text(tu_text);
                $(".annui", oFocusContainer).append("<span></span>");
            }
            ...
            $(".annui", oFocusContainer).width(oFocus.outerWidth(true) * num).css({
                position: 'absolute',
                right: 10,
                top: '50%',
                marginTop: -$(this).find('span').width() / 2
            });
             $(".js_text", oFocusContainer).width(oFocus.outerWidth(true) * num).css({
                position: 'relative',
                color: '#fff',
                top: '3px',
                left: '5px'
            ...
            function doMove(){
                ...
                console.log(iCurr);
                var tu_text=$(".slider ul li a img").eq(iCurr).attr("title");
            	$(".js_text").text(tu_text);
