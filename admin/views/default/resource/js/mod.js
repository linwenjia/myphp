	...
	var controller = {
		...
		GenerBtn:function(){
			...
			$('#generate').click(function(){
				...
				$.ajax({
					url:'/admin.php/controller/ajaxMod',
					type:'post',
					data:{'controller_id':controller_id,'postDate':o,'dele_arr':self.dele_arr},//传给后台参数
					dataType:'json',
					success:function(data){
						console.log(data);
		...
		DeleObj:function(){
			...
			$('#dele_obj').click(function(){
				...
				if(self.arrobj[self.obj_index].id != undefined){
					self.dele_arr.push(self.arrobj[self.obj_index].id);
				}
		...
		ModData:function(){
			var self = this;
			$.ajax({
				url:'/admin.php/controller/getControllerInfo',
				type:'post',
